...
public class VentanaDavid extends JPanel {
	...
	public VentanaDavid() {
		...
		txtpnDavid.setEditable(false);
		txtpnDavid.setBounds(133, 13, 122, 22);
		add(txtpnDavid);
		...
		txtpnGarcaLera.setEditable(false);
		txtpnGarcaLera.setBounds(133, 48, 122, 22);
		add(txtpnGarcaLera);
